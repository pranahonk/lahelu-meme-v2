...
const EditingToolbar = ({ selectedElement, onEditText, onColorPress, onFontPress }: EditingToolbarProps) => {
  ...
  return (
    <View style={styles.container}>
      <ToolbarButton iconName="color-palette-outline" onPress={onColorPress} label="Color" />
      <ToolbarButton iconName="remove-outline" onPress={() => handleFontSizeChange(-2)} />
      <ToolbarButton iconName="add-outline" onPress={() => handleFontSizeChange(2)} />
      <ToolbarButton iconName="text-outline" onPress={onEditText} label="Edit Text" />
      <ToolbarButton iconName="options-outline" onPress={onFontPress} label="Font" />
